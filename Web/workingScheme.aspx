<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="workingScheme.aspx.cs" Inherits="Web.workingScheme" %>
...
<body>
    <form id="form1" runat="server">
        ...
        <asp:DropDownList ID="elementList" runat="server" Height="26px" AutoPostBack="True"
            ...
            <asp:ListItem Value="2">Схема 2</asp:ListItem>
            <asp:ListItem Value="3">Схема 3</asp:ListItem>
        </asp:DropDownList>
        <br>
		    <div>
					<p>&nbsp; &nbsp; &nbsp; &nbsp;&nbsp;<asp:Table ID="Table2" runat="server" 
                            BackColor="Black" BorderWidth="2px" GridLines="Both">
                        </asp:Table>
                    </p>
					<p>

        <input name="chooseIt" type="button" value="Посмотреть компоненты схемы"></p>
					<p>Состовные компоненты схемы:</p>
					<p><select name="ElementsOfscheme" size="5"></select>&nbsp;</p>
					<p><input name="addElement" type="button" value="Добавить компонент в свою схему" 
                            style="width: 279px"></p>
					<br>
					<br>
					<p>Ваш набор компонентов:</p>
					<p><select name="selectedElements" size="5"></select>&nbsp;</p>
					<p><input name="deleteElement" type="button" value="Удалить из набора"></p>
		<br>
		<br>
		<br>
		<br>
